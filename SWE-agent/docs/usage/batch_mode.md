...
!!! tip "Evaluating predictions"
    This repo generates `preds.json` but does not run SWE-bench evaluation. Pass the predictions to [SWE-bench-modified](../SWE-bench-modified/README.md) (`run_evaluation`) or another harness.
